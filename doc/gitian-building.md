...
*Setup instructions for a gitian build of BLTG Core using a VM or physical system.*

Gitian is the deterministic build process that is used to build the BLTG
...
to the BLTG GitHub release page.

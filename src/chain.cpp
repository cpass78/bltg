...
CBlockHeader CBlockIndex::GetBlockHeader() const
{
    ...
    if (nVersion >= 5) block.hashFinalSaplingRoot = hashFinalSaplingRoot;
    return block;
}
...
int64_t CBlockIndex::MinPastBlockTime() const
{
    ...
    // so we allow the nBlockTimeProtocolV2 (BLTG v4.0) to be at most (180-14) seconds earlier than previous block

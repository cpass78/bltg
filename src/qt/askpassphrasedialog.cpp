...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            BLTGGUI* window = static_cast<BLTGGUI*>(parentWidget());
...
{
    BLTGGUI* gui = static_cast<BLTGGUI*>(parentWidget());
...
{
    hide();
    static_cast<BLTGGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BLTG will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BLTG/s from being stolen by malware infecting your computer.") +
            "<br><br><b>" +

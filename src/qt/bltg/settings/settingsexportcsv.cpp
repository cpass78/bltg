...
#include "qt/bltg/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(BLTGGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("BLTG_tx_csv_export(*.csv)") : tr("BLTG_addresses_csv_export(*.csv)"),
                                        nullptr);

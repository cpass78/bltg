...
#include "qt/bltg/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(BLTGGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &BLTGGUI::openFAQ);

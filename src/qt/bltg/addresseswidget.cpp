...
#include "qt/bltg/forms/ui_addresseswidget.h"
#include "qt/bltg/addresslabelrow.h"
#include "qt/bltg/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(BLTGGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination bltgAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(bltgAdd, label.toUtf8().constData(),

    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopBltg}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // BLTG
    // Top
    ui->labelAmountTopBltg->setText(totalBltg);
    // Expanded
    ui->labelAmountBltg->setText(totalBltg);
    ui->labelPendingBltg->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));

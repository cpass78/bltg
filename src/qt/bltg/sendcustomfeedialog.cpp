...
#include "qt/bltg/sendcustomfeedialog.h"
#include "qt/bltg/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(BLTGGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &BLTGGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

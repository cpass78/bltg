...
#ifndef BLTG_CORE_NEW_GUI_BLTGGUI_H
#define BLTG_CORE_NEW_GUI_BLTGGUI_H
...
#include "qt/bltg/navmenuwidget.h"
...
/**
  BLTG GUI main class. This class represents the main window of the BLTG UI. It communicates with both the client and
...
public:
    ...
    explicit BLTGGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~BLTGGUI();
...
#endif //BLTG_CORE_NEW_GUI_BLTGGUI_H

...
#include "qt/bltg/txviewholder.h"
#include "qt/bltg/tooltipmenu.h"
#include "qt/bltg/sendmultirow.h"
#include "qt/bltg/coldstakingmodel.h"
#include "qt/bltg/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(BLTGGUI* parent);
    ~ColdStakingWidget();

...
#include "qt/bltg/forms/ui_masternodeswidget.h"

#include "qt/bltg/qtutils.h"
#include "qt/bltg/mnrow.h"
#include "qt/bltg/mninfodialog.h"
#include "qt/bltg/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(BLTGGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 12000)) {
        inform(tr("Not enough balance to create a masternode, 12,000 %1 required.").arg(CURRENCY_UNIT.c_str()));
        return;
    }
    showHideOp(true);

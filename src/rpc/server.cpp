...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BLTG features */
        {"bltg", "listmasternodes", &listmasternodes, true },
        {"bltg", "getmasternodecount", &getmasternodecount, true },
        {"bltg", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"bltg", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"bltg", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"bltg", "masternodecurrent", &masternodecurrent, true },
        {"bltg", "startmasternode", &startmasternode, true },
        {"bltg", "createmasternodekey", &createmasternodekey, true },
        {"bltg", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"bltg", "listmasternodeconf", &listmasternodeconf, true },
        {"bltg", "getmasternodestatus", &getmasternodestatus, true },
        {"bltg", "getmasternodewinners", &getmasternodewinners, true },
        {"bltg", "getmasternodescores", &getmasternodescores, true },
        {"bltg", "preparebudget", &preparebudget, true },
        {"bltg", "submitbudget", &submitbudget, true },
        {"bltg", "mnbudgetvote", &mnbudgetvote, true },
        {"bltg", "getbudgetvotes", &getbudgetvotes, true },
        {"bltg", "getnextsuperblock", &getnextsuperblock, true },
        {"bltg", "getbudgetprojection", &getbudgetprojection, true },
        {"bltg", "getbudgetinfo", &getbudgetinfo, true },
        {"bltg", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"bltg", "mnfinalbudget", &mnfinalbudget, true },
        {"bltg", "checkbudgets", &checkbudgets, true },
        {"bltg", "mnsync", &mnsync, true },
        {"bltg", "spork", &spork, true },
        ...
        {"zerocoin", "getzbltgseed", &getzbltgseed, false },
        {"zerocoin", "setzbltgseed", &setzbltgseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzbltg", &searchdzbltg, false },
        {"zerocoin", "dzbltgstate", &dzbltgstate, false },
...
{
    return "> bltg-cli " + methodname + " " + args + "\n";
}

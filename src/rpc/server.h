...
extern UniValue setzbltgseed(const JSONRPCRequest& request);
extern UniValue getzbltgseed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzbltg(const JSONRPCRequest& request);
extern UniValue dzbltgstate(const JSONRPCRequest& request);

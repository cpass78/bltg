...
enum SporkId : int32_t {
    SPORK_2_SWIFTTX                             = 10001,      // Deprecated in v4.0.0
    SPORK_3_SWIFTTX_BLOCK_FILTERING             = 10002,      // Deprecated in v4.0.0
    ...
    SPORK_17_COLDSTAKING_ENFORCEMENT            = 10017,       // Deprecated in 4.0.0

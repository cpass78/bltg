...
const unsigned char BLTG_HD_SEED_FP_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
    {'B', 'L', 'T', 'G', '_', '_', 'H', 'D', '_', 'S', 'e', 'e', 'd', '_', 'F', 'P'};

const unsigned char BLTG_TADDR_OVK_PERSONAL[crypto_generichash_blake2b_PERSONALBYTES] =
        {'B', 'g', 'T', 'a', 'd', 'd', 'r', 'T', 'o', 'S', 'a', 'p', 'l', 'i', 'n', 'g'};
...
{
    CBLAKE2bWriter h(SER_GETHASH, 0, BLTG_HD_SEED_FP_PERSONAL);
    h << seed;
    return h.GetHash();
}

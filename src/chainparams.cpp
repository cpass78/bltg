...
static Checkpoints::MapCheckpoints mapCheckpoints = {
        ...
        {34,     uint256S("0x0000037a97a63f1bc451a35adda4f07f6e591e2c8a689f9b990ccd1d2f9713f8")},
        ...
        {699000, uint256S("0xcd82832c0a838101229ac734fca65d89cb85ee2519f813c5487f3eef4f28a3b4")}, //Bip65 and UPGRADE_V3_4 = new stake modifier

};

static const Checkpoints::CCheckpointData data = {
        &mapCheckpoints,
        1582313311, // * UNIX timestamp of last checkpoint block
        1458497,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1531154631, 1568802, 0x1e0ffff0, 1, 50 * COIN);
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // BLTG starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        consensus.nBudgetCycleBlocks = 43200;       // approx. 1 every 30 days
        consensus.nBudgetFeeConfirmations = 6;      // Number of confirmations for the finalization fee
        consensus.nCoinbaseMaturity = 10; //Network rule breaking this
        ...
        // validation by-pass
        consensus.nBltgBadBlockTime = 1540080487;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nBltgBadBlockBits = 0x1e00bc6b;    // Skip nBit validation of Block 259201 per PR #915
        ...
        consensus.ZC_TimeStart = 2147483647;        // October 17, 2017 4:30:00 AM
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].nActivationHeight          = 699000;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].hashActivationBlock =
                uint256S("0xcd82832c0a838101229ac734fca65d89cb85ee2519f813c5487f3eef4f28a3b4");
        ...
        vSeeds.emplace_back("seed1.block-logic.com", "seed1.block-logic.com", true);     // Primary DNS Seeder
        vSeeds.emplace_back("seed2.block-logic.com", "seed2.block-logic.com", true);    // Secondary DNS Seeder
...
//        vSeeds.emplace_back(("fuzzbawls.pw", "bltg-testnet.seed.fuzzbawls.pw", true);
//        vSeeds.emplace_back(("fuzzbawls.pw", "bltg-testnet.seed2.fuzzbawls.pw", true);
        ...
        // Sapling
        bech32HRPs[SAPLING_PAYMENT_ADDRESS]      = "btestsapling";
        bech32HRPs[SAPLING_FULL_VIEWING_KEY]     = "bviewtestsapling";
        bech32HRPs[SAPLING_INCOMING_VIEWING_KEY] = "bltgktestsapling";
        bech32HRPs[SAPLING_EXTENDED_SPEND_KEY]   = "b-secret-spending-key-test";
        bech32HRPs[SAPLING_EXTENDED_FVK]         = "bxviewtestsapling";
    }

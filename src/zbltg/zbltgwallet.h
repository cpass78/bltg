...
#ifndef BLTG_ZBLTGWALLET_H
#define BLTG_ZBLTGWALLET_H
...
public:
    ...
    void GenerateDeterministicZBLTG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBLTG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

...
#ifndef BLTG_ZBLTGTRACKER_H
#define BLTG_ZBLTGTRACKER_H
...
public:
    CzBLTGTracker(CWallet* parent);
    ~CzBLTGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBLTGWallet* zBLTGWallet = NULL);

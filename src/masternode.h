...
//
// The Masternode Class. It contains the input of the 12000 BLTG, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 12000 BLTG - checking if valid masternode)

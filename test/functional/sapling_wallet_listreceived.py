...
class ListReceivedTest (PivxTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 BLTG.
        ...
        # Send 1 BLTG to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 BLTG sending them all (fee is 0.1 BLTG)
        ...
        # Confirm transaction (2 BLTG from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 BLTG, send 0.6 BLTG + 0.05 BLTG fee

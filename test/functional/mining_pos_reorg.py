...
class ReorgStakeTest(BltgTestFramework):
    ...
    def run_test(self):
        ...
        # Check BLTG and zPIV supply at the beginning
        # ------------------------------------------
        ...
        # BLTG supply: block rewards minus burned fees for minting
        ...
        # Verify that BLTG and zPIV supplies were properly updated after the spends and reorgs
        self.log.info("Check BLTG and zPIV supply...")
